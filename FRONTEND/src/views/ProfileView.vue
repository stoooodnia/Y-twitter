...
<div class="dark w-full min-h-screen bg-gray-900 text-white">
  ...
  <main class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-12 space-y-8">
      <div
        class="group flex flex-col gap-4 py-2 border border-gray-800 rounded-lg"
      >
          ...
          <div class="flex items-start p-4">
            <div class="flex items-start gap-4 text-sm">
              ...
              <div class="grid gap-1">
                ...
                <div class="line-clamp-1 text-xs">@yourhandle</div>
              </div>
            </div>
